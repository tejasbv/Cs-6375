...
# specify path to training daa and testing data

train_x_location = f"x_train_10.csv"
train_y_location = f"y_train_10.csv"
...
param_grid = {
    ...
    'kernel': ['poly'],
    'degree': [2,],  
    'gamma': ['scale', 'auto'] + list(np.logspace(-3, 2, 6))  # Used for 'poly' kernel
}
