...
f_y = "y_test.csv"
p = .05
#random int in python?
for i in range(10):

    seed = random.randint(2, 1234)

    #how to generate random int in python?
    np.random.seed(fastrand.pcg32bounded(1234))
    ...
    f_x_out = out_name(f_x,p,i)
    f_y_out = out_name(f_y,p,i)
